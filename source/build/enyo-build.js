...
windowDeactivated: function(a) {
this.tracking && this.mouseup(a);
},
focus: function(a) {
...
while (a) {
b = enyo.$[a.id];
if (b instanceof enyo.BasicScroller) return b;
a = a.parentNode;
}
},
...
this.hasNode() && this.node[a] && this._serverConnected ? (this.flushCallQueue(), a == "setHTML" ? this.log(a) : this.log(a, b), this.node[a].apply(this.node, b)) : (this.log("queued!", a, b), this.callQueue.push({
name: a,
args: b
...
var a = this.callQueue;
this.callQueue = [];
if (this.hasView()) {
var b = a.length;
for (var c = 0, d; c < b; c++) d = a.shift(), this.callBrowserAdapter(d.name, d.args);
...
_cachedSelectPopups: {},
create: function(a) {
this.chrome[0].cacheAdapter = a.cacheAdapter, this.inherited(arguments), this.identifierChanged(), this.minFontSizeChanged(), this.enableJavascriptChanged(), this.blockPopupsChanged(), this.acceptCookiesChanged(), this.redirectsChanged(), this.networkInterfaceChanged(), this.ignoreMetaTagsChanged(), this.urlChanged();
},
...
return {
x: -c.left + 2 * (d.left + b.left),
y: -c.top + 2 * (d.top + b.top)
};
}
...
clickHandler: function(a, b) {
this.findSlidingHandler(b.dispatchTarget) && this.toggleSelected(), this.doClick(b);
},
...
this.dx0 = 0;
if (d) {
this.stopAnimation(), this.dragSliding(d, b, 0);
return !0;
}
}
},
