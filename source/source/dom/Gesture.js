...
//* @protected
	...
	// FIXME: can miss mouseup if window deactivates while mouse is down,
	// have asked that system change this behavior, until then, workaround.
	...
	endPreventFocus: function(e) {
		...
		} else if (this.needsCustomFocus && e && e.target) {
